module memory_wait_controller
  ...
  // cpu cycler
  // keep original fetch/execute timing so PC/update logic does not shift by 1 cycle
  ...
  begin
    ...
    begin
      case (state_cycler)
        C_REQ_FETCH:
        begin
          // original behavior: fetch_req pulse is asserted by previous state,
          // then cleared here while waiting for fetch_done.
          fetch_req    <= 1'b0;
          execute_now  <= 1'b0;
